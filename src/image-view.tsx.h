...
static void image_view_load_template(ui_widget_t *parent, image_view_refs_t *refs)
{
        ...
        ui_widget_append(refs->content, w[1]);
        ...
        ui_widget_add_class(w[5], "file-info");
        refs->ref_24 = ui_create_widget("text");
        ui_widget_add_class(refs->ref_24, "fui-icon-regular mr-2");
        ...
        ui_widget_add_class(refs->ref_26, "fui-icon-regular mr-2");
        ui_widget_set_text(refs->ref_26, (const char*)widget_text_9);
        ...
        ui_widget_add_class(refs->ref_30, "fui-icon-regular icon");
        ui_widget_set_text(refs->ref_30, (const char*)widget_text_12);
        refs->ref_31 = ui_create_widget("text");
        ui_widget_add_class(refs->ref_31, "fui-icon-filled icon");
        ui_widget_set_text(refs->ref_31, (const char*)widget_text_13);
        ui_widget_append(refs->toggle_fit, refs->ref_30);
        ui_widget_append(refs->toggle_fit, refs->ref_31);
        ...
        ui_widget_append(w[3], refs->toggle_fit);
        ...
        ui_widget_append(parent, refs->file_info_panel);
}
